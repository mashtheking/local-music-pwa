...
<button style="width:100%;text-align:center;margin-left:5px;margin-right:5px;margin-top:5px;margin-bottom:5px; ;height:50px;border-style:none;text-size:26px" class={styles.tonalButton}> Add Music </button>
</a>
